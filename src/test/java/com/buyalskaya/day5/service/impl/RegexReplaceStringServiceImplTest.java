...
public class RegexReplaceStringServiceImplTest {
    RegexReplaceStringServiceImpl regexReplaceStringService = new RegexReplaceStringServiceImpl();

    @BeforeClass
    public void setUp() {
        regexReplaceStringService = new RegexReplaceStringServiceImpl();
    }
    ...
    public void replaceSymbolTestParams(String inputString, char symbol,
        ...
        try {
            String actual = regexReplaceStringService.replaceSymbol(inputString, symbol, position);
    ...
    public void replaceSymbolTestNull() {
        ...
        assertThrows(ProjectException.class,
                () -> regexReplaceStringService.replaceSymbol(inputString, 't', 2));
    }
    ...
    public void replaceSymbolTestPositionGreaterThenLength() {
        String inputString = "Hello";
        assertThrows(ProjectException.class,
                () -> regexReplaceStringService.replaceSymbol(inputString, 't', 6));
    }
    ...
    public void replaceLetterAfterSuitableLetterTestParams(String inputString, char letterAfterWhichReplacement,
        ...
        try {
            String actual = regexReplaceStringService.
    ...
    public void replaceLetterAfterSuitableLetterTestNull() {
        String inputString = null;
        assertThrows(ProjectException.class,
                () -> regexReplaceStringService.replaceLetterAfterSuitableLetter(inputString,
                        'p', 'a', 'o'));
    }
    ...
    public void replaceWordSuitableLengthTestNullSubstring() {
        ...
        assertThrows(ProjectException.class,
                () -> regexReplaceStringService.replaceWordSuitableLength(inputString,
                        10, newSubstring));
    }
